...
public:
    ...
    // spawnX/spawnY：显式出生坐标（>=0 时优先使用，用于战斗结束返回触发点）
    VillageScene(std::string mapFile, bool spawnAtEntrance = false, int spawnX = -1, int spawnY = -1);
...
private:
    ...
    int explicitSpawnX = -1;
    int explicitSpawnY = -1;
